...
import RestaurantItem from '@/components/trip/RestaurantItem';
import FlightItem from '@/components/trip/FlightItem';
                  ...
                  >
                    {items
                      ...
                      .map((item) => (
                        ...
                        >
                          {item.type === 'flight' ? (
                            <FlightItem item={item} trip={trip} />
                          ) : item.type === 'hotel' ? (
                            <HotelItem item={item} trip={trip} />
                          ) : item.type === 'transfer' ? (
                            <TransferItem item={item} trip={trip} />
                          ) : item.type === 'activity' ? (
                            <ActivityItem item={item} trip={trip} />
                          ) : item.type === 'restaurant' ? (
                            <RestaurantItem item={item} trip={trip} />
                          ) : null}
                        </div>
                      ))}
                  </div>
